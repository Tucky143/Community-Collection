package net.mcreator.communitycollection;
...
@Mod("community_collection")
public class CommunityCollectionMod {
	public static final Logger LOGGER = LogManager.getLogger(CommunityCollectionMod.class);
	public static final String MODID = "community_collection";

	public CommunityCollectionMod(IEventBus modEventBus) {
