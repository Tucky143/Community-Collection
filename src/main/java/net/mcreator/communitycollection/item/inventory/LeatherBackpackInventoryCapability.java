...
public class LeatherBackpackInventoryCapability extends ComponentItemHandler {
	...
	public static void onItemDropped(ItemTossEvent event) {
		if (event.getEntity().getItem().getItem() == CommunityCollectionModItems.LEATHER_BACKPACK.get()) {
			Player player = event.getPlayer();
			if (player.containerMenu instanceof LeatherBackpackGUIMenu)
	...
	public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
		return stack.getItem() != CommunityCollectionModItems.LEATHER_BACKPACK.get();
	}
